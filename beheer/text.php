...
<?php 
	...
	if(isset($_GET['save']))
	{
		$infotext = $_GET['text_info'];
		$page1title = $_GET['text_page1title'];
		$page1subheader = $_GET['text_page1subheader'];
		$page1body = $_GET['text_page1body'];
		$page2title = $_GET['text_page2title'];
		$page2subheader = $_GET['text_page2subheader'];
		$page2body = $_GET['text_page2body'];
		$footertext = $_GET['text_footer'];
		$footerheader = $_GET['text_footerheader'];
